 ...
 * @property {-1 | 0 | 1 | 2} readyState
 */
/**
 * @typedef {Object} _MessageEvent
 * @property {string} [id]
 ...
 */
/**
 * @typedef {Object} _OpenEvent
 * @property {number} responseCode
 * @property {Object.<string, string[]>} [headers]
 */
/**
 * @typedef {CustomEvent & { source: SSE }} _CommonEventProperties
 */
/**
 * @typedef {_CommonEventProperties & _ReadyStateEvent} ReadyStateEvent
 */
/**
 * @typedef {_CommonEventProperties & _OpenEvent} OpenEvent
 */
/**
 * @typedef {_CommonEventProperties & _MessageEvent} MessageEvent
 */
/**
 * @typedef {_CommonEventProperties & _ErrorEvent} ErrorEvent
 */
/**
 * @typedef {_CommonEventProperties} AbortEvent
 */
/**
 * @typedef {ReadyStateEvent | OpenEvent | MessageEvent | ErrorEvent | AbortEvent} SSEvent
 */
/**
 * @callback _AddReadyStateChangeEventListener
 * @param {"readystatechange"} type
 * @param {(event: MessageEvent | ReadyStateEvent) => void} listener
 * @returns {void}
 */
/**
 * @callback _AddOpenEventListener
 * @param {"open"} type
 * @param {(event: MessageEvent | OpenEvent) => void} listener
 * @returns {void}
 */
/**
 * @callback _AddMessageEventListener
 * @param {string} type
 * @param {(event: MessageEvent) => void} listener
 * @returns {void}
 */
/**
 * @callback _AddErrorEventListener
 * @param {"error"} type
 * @param {(event: MessageEvent | ErrorEvent) => void} listener
 * @returns {void}
 */
/**
 * @callback _AddAbortEventListener
 * @param {"abort"} type
 * @param {(event: MessageEvent | AbortEvent) => void} listener
 * @returns {void}
 */
/**
 * @typedef {_AddReadyStateChangeEventListener & _AddOpenEventListener & _AddMessageEventListener & _AddErrorEventListener & _AddAbortEventListener} AddEventListener
 */
/**
 * @callback RemoveEventListener
 * @param {string} type
 * @param {(event: SSEvent) => void} listener
 * @returns {void}
 */
/**
...
/**
 * @callback OnOpen
 * @param {OpenEvent | MessageEvent} event
 * @returns {void}
 */
/**
 * @callback OnReadystatechange
 * @param {ReadyStateEvent | MessageEvent} event
 * @returns {void}
 */
/**
 * @callback OnError
...
/**
 * @callback OnAbort
 * @param {AbortEvent | MessageEvent} event
 * @returns {void}
 */
/**
 * @typedef {Object} SSE
